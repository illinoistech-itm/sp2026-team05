...
build {
  ...
  provisioner "shell" {
    ...
    environment_vars = ["DBUSER=${local.DBUSER}", "DBPASS=${local.DBPASS}", "DATABASE=${local.DATABASE}", "FQDN=${local.FQDN}", "AUTH_SECRET=${local.AUTH_SECRET}", "AUTH_GOOGLE_ID=${local.AUTH_GOOGLE_ID}", "AUTH_GOOGLE_SECRET=${local.AUTH_GOOGLE_SECRET}"]
