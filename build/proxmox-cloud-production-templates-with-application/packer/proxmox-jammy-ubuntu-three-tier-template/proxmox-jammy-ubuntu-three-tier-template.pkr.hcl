...
build {
  ...
  provisioner "shell" {
    ...
    environment_vars = ["DBUSER=${local.DBUSER}", "DBPASS=${local.DBPASS}", "DATABASE=${local.DATABASE}", "FQDN=${local.FQDN}", "AUTH_SECRET=${local.AUTH_SECRET}", "AUTH_GOOGLE_ID=${local.AUTH_GOOGLE_ID}", "AUTH_GOOGLE_SECRET=${local.AUTH_GOOGLE_SECRET}", "CLIENTID=${local.CLIENTID}", "CLIENTSECRET=${local.CLIENTSECRET}", "AUTH_TRUST_HOST=${local.AUTH_TRUST_HOST}", "AUTH_URL=${local.AUTH_URL}", "NEXTAUTH_SECRET=${local.NEXTAUTH_SECRET}", "NEXTAUTH_URL=${local.NEXTAUTH_URL}" ]
