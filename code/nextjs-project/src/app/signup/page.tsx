    ...
    >
      ...
      <div className="flex-1 flex items-center justify-center px-4 pb-16">
        <div className="w-full max-w-xs animate-slide-up">
          <p className="font-mono text-white text-sm mb-2 tracking-wide">Sign Up</p>
          ...
          >
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-3 py-3 rounded-xl font-mono text-sm font-bold transition-all hover:scale-105"
            ...
            {[
              ...
              <div key={label}>
                <label className="block font-mono text-xs text-white mb-2">{label}</label>
                <input
                  type={type}
                  value={value}
            ...
            <button
              ...
              className="w-full font-mono text-xs underline"
              style={{ background: "none", border: "none", cursor: "pointer", color: "#00BFB3" }}
            >
